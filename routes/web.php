...
Route::middleware('level')->group(function() {
    ...
    Route::get('/categories',[categorycontroller::class,'insertcategory'])->name('insertcategory');
    Route::post('/categoryinserted',[categorycontroller::class,'categoryinserted'])->name('categoryinserted');
